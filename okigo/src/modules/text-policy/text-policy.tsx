...
export const TextPolicy = () => {
  ...
  return (
    <div>
      ...
      <h3 class='text-block__subtitle'>Политика в отношении обработки персональных данных</h3>
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>1. Общие положения</h4>
        <div class="text-block__text-container">
          <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые (далее — Оператор).</p>
          <p>1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</p>
          <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта<a class='text-policy__links' href="https://vklist.ru">https://vklist.ru</a>.</p>
        </div>
      </div>
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>2. Основные понятия, используемые в Политике</h4>
        <div class='text-block__text-container'>
          <p>2.1. Автоматизированная обработка персональных данных — обработка персональных данных с помощью средств вычислительной техники.</p>
          <p>2.2. Блокирование персональных данных — временное прекращение обработки персональных данных (за исключением случаев, если обработка необходима для уточнения персональных данных).</p>
          <p>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a class='text-policy__links' href="https://vklist.ru">https://vklist.ru</a>.</p>
          ...
          <p>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a class='text-policy__links' href="https://vklist.ru">https://vklist.ru</a>.</p>
          <p>2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).</p>
          <p>2.10. Пользователь — любой посетитель веб-сайта <a class='text-policy__links' href="https://vklist.ru">https://vklist.ru</a>.</p>
      ...
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>3. Основные права и обязанности Оператора</h4>
        <div class='text-block__text-container'>
      ...
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>4. Основные права и обязанности субъектов персональных данных</h4>
        <div class='text-block__text-container'>
      ...
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>5. Принципы обработки персональных данных</h4>
        <div class='text-block__text-container'>
      ...
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>6. Цели обработки персональных данных</h4>
        <div class='text-block__text-container'>
          <ul>
            <li>Цель обработки информирование Пользователя посредством отправки электронных писемПерсональные данные
              <ul>
            ...
            <li>Виды обработки персональных данных
              <ul>
      ...
      <div class='text-block__list-block'>
        <h4 class='text-block__subtitle'>7. Условия обработки персональных данных</h4>
        <div class='text-block__text-container'>
      ...
      {/* <div class='text-policy__list-block'>
        <h4 class='text-policy__sub-title'></h4>
        <div class="text-policy__text-container">
          <p></p>
          <p></p>
        </div>
      </div> */}
