...
// src/html-parser/base-html-parser/base-html-parser.ts
var base_html_parser_exports = {};
__export(base_html_parser_exports, {
  HTMLElementResolver: () => HTMLElementResolver
});
module.exports = __toCommonJS(base_html_parser_exports);
var import_map_attribute_name = require("../../string-template-parser/map-attribute-name.cjs");
